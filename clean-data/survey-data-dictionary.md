...
The survey itself was separated into two parts: (1) information about coding and
(2) demographic information.

This is **not** the same as the two parts of the raw data. The first dataset
(`2016 New Coders Survey Part 1.csv`) contains all responses for the first half
of the survey. The second dataset (`2016 New Coders Part 2.csv`) contains all
responses for the first and second parts of the survey of those who submitted
